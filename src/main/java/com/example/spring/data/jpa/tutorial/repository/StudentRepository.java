...
public interface StudentRepository extends JpaRepository<Student,Long> {
    ...
    //Native Name Param
    @Query(value = "SELECT * FROM tb_student s where s.email_address =:emaildId",nativeQuery = true)
    Student getStudentByEmailAddressNativeNameParam(@Param("emaildId")String emailId);
